      ...
      <div class="comment_wrapper" :class="{shown: commentShown}" @click="hideComment">
        <div class="bottom_comment_container">
          <!--<Input type="textarea"-->
                 ...
                 <!--@on-blur="hideComment"-->
          <!--/>-->
          <textarea wrap="soft" autocomplete="off" spellcheck="false" placeholder="写评论..." rows="2" class="ivu-input" style="height: 31px; min-height: 31px; max-height: 94px;"></textarea>
