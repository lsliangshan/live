<template>
  <div class="detail_website_container">
    <div class="detail_website_header">
      <span>修改网址</span>
    ...
    <group gutter="0px" class="detail_website_inner">
      <x-input placeholder="请输入您的网址"
               class="website_input"
               autofocus="autofocus"
...
<style scoped lang="less">
  .detail_website_container {
    width: 100%;
    height: 100%;
  }
  .detail_website_header {
    position: relative;
    width: 100%;
    height: 44px;
