<template>
  <div class="login_container">
    <div class="bg_image" :style="{backgroundImage: 'url(https://ss1.bdstatic.com/70cFuXSh_Q1YnxGkpoWK1HF6hhy/it/u=797016050,588323013&fm=27&gp=0.jpg)'}">
      ...
      <div class="login_form_container" v-if="action === 'login'">
        <group gutter="0px" class="login_form_inner">
          ...
          <div class="form_item">
            ...
            <input type="text" class="custom_input" placeholder="用户名" v-model="loginFormData.username"/>
          </div>
          <div class="gap_12"></div>
          <div class="form_item">
            <svg>
            ...
            <input type="password" class="custom_input" placeholder="密码" v-model="loginFormData.password"/>
          </div>
          ...
          <div class="form_bottom">
            <button class="custom_button" @click="login">登录</button>
          </div>
      ...
      <div class="login_form_container" v-if="action === 'registry'">
        <group gutter="0px" class="login_form_inner">
          ...
          <div class="form_item">
            ...
            <input type="text" class="custom_input" placeholder="手机号" v-model="registryFormData.phonenum"/>
          </div>
          <div class="gap_12"></div>
          <div class="form_item">
            <svg>
            ...
            <input type="password" class="custom_input" placeholder="密码" v-model="registryFormData.password"/>
          </div>
          <div class="gap_12"></div>
          <div class="form_item">
            <svg>
            ...
            <input type="password" class="custom_input" placeholder="确认密码" v-model="registryFormData.rePassword"/>
          </div>
          <div class="gap_24"></div>
          ...
          <!--</x-button>-->
          <div class="form_bottom">
            <button class="custom_button" @click="registry">注册</button>
          </div>
