...
.head_icon_inner {
  ...
  -moz-transition: opacity 0.3s cubic-bezier(0.4, 0, 0.22, 1);
  -ms-transition: opacity 0.3s cubic-bezier(0.4, 0, 0.22, 1);
  -o-transition: opacity 0.3s cubic-bezier(0.4, 0, 0.22, 1);
